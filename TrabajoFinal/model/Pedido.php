...
class Pedido
{
    ...
    public function insert()
    {
        ...
        $resultado = $conexion->query(
            "INSERT INTO Pedido (IDPedido, IDSolicitante, IDUsuario, Descripcion, FechaHora)
              VALUE (NULL , " . $this->getSolicitante()->getIdSolicitante() . ", " .
            $this->getusuario()->getIDUsuario() . ", '" . $this->getDescripcion() . "', '" .
            $this->getFechaHora() . "')");
        ...
        if ($conexion->error) {
            ...
            return true;// ("<span style='color:green;'> Registro insertado correctamente</span>");
        }
    }
