...
<table border="1" class=" table table-bordered ">
    ...
    <tr>
        ...
        <td>
            ...
            style="text-decoration:none; font-size: 30px; margin:130px; padding: 20px;"
               href="../controller/controllerPedido.php?action=listar">Pedido</a>
        </td>

        <td>
            <a  class="btn btn-warning"  style="text-decoration:none; font-size: 30px; margin:130px; padding: 20px;"
            href="../controller/controllerCisterna.php?action=index">Cisterna</a>
        </td>

        <td>
            <a  class="btn btn-danger"  style="text-decoration:none; font-size: 30px; margin:130px; padding: 20px;"
